					...
					<TABLE aling="center" CELLPADDING="0" WIDTH="100%" HEIGHT="100%" BACKGROUND="">
						<TR>
							<TD ALIGN="center" COLSPAN="0">
								<br>YOUR LOGO HERE<br><br>
								<B><font face="arial,verdana" size="3"><br><?php echo $L_ADMINISTRACAO; ?></font></B><br><br>
							</TD>
						</TR>
						<TR>
							<td ALIGN="center" VALIGN="middle">
								...
								<table width="190" cellpadding=0 cellspacing=0 BACKGROUND="">
									<tr>
										...
										<td align="right">
											<INPUT TYPE=image src="img/enter.gif" WIDTH="26" HEIGHT="23" border=0 hspace=7 vspace=4 alt="<?php echo $L_IR ; ?> &gt;&gt;&gt;" TABINDEX="1">
										</td>
									</tr>
								</table>
							</td>
