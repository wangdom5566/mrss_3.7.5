...
<script Language="JavaScript">
	...
	if($sistema1==0){
		...
		echo(".<br>$L_HOJE_E "); echo $nomes_meses["$mes78"]; echo(" "); echo $dia78; echo(", "); echo $ano78; echo(" ($tempo78)");
	...
	<center><font face="verdana,arial" size="1" color="#4682B4"><?php echo $L_TITULO; ?> v.<?php include('versao.inc.php'); echo $versao; ?><BR>Developed by Ighor Toth - http://www.ighor.com
	<?php
