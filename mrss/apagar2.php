					...
					<tr align="center">	
						<td align="center" >
							...
							<table width="100%">
								...
								<tr>	
									<td>
									<font size=2 face="arial"><?php echo $L_SALA; ?>: &nbsp;
							...
							<table border="0" width="100%" bgcolor="#9EC8FF">
								<tr align="center">	
									<td align="left">
										...
										<BUTTON border="0" class="bordas" OnClick="AAA=window.open('user2.php','_self');">
											<?php echo $L_VOLTAR; ?>
										</BUTTON>
									</td>
									<td align="right">
							...
							<table border="0" width="100%" bgcolor="#9EC8FF">
								...
								<tr bgcolor="#EDF5FF">
									...
									<td width="5%" align="center"><font size=2 face="arial">
										...
										<IMG SRC="img/apagar.gif" alt="Select/Un-Select (Delete)" border="0">
									</td>
									<td  width="50%" align="left"><font size=2 face="arial"><font color='#4682B4'>
										<b><center><?php echo $L_DATE; ?>
									</td>
