...
if($usuario == "your_MySQL_user"){ 
	echo ("<b><font color=\"red\" face=\"arial,verdana\" size=\"2\">");
	echo ("WARNING: You need to configure the file \"conf.inc.php\". Please do it before trying to use the system! Thank you.");
	echo ("<br><br>ATENÇÃO: Você precisa configurar o arquivo \"conf.inc.php\". Por favor faça isso antes de usar o sistema. Obrgado.");  
	echo ("<br><br>WARNUNG: Sie müssen die Datei \"conf.inc.php\" konfigurieren. Tun Sie es bitte vor dem Versuchen, system zu verwenden! Danke.");
	echo ("<br><br>ADVERTENCIA: Necesitas configurar el archivo \"conf.inc.php\". ¡Hacerlo por favor antes de intentar utilizar el sistema! Gracias.</b>");
	exit();
}
